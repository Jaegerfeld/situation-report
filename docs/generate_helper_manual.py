...
def make_styles() -> dict:
    ...
    return dict(
        h1=s("H1h", fontName="Helvetica-Bold", fontSize=18, textColor=C_BLUE,
              spaceBefore=24, spaceAfter=8),
        h2=s("H2h", fontName="Helvetica-Bold", fontSize=13, textColor=C_ACCENT,
              spaceBefore=14, spaceAfter=5),
        body=s("Bodyh", fontName="Helvetica", fontSize=10, leading=15,
               alignment=TA_JUSTIFY, spaceAfter=6),
        bullet=s("Bulleth", fontName="Helvetica", fontSize=10, leading=14,
        ...
        hint=s("Hinth", fontName="Helvetica-Oblique", fontSize=9,
               textColor=C_HINT, leading=13, leftIndent=12, spaceAfter=4),
        center=s("Centerh", fontName="Helvetica", fontSize=10, leading=15,
