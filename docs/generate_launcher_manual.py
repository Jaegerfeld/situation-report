    ...
    story += [
        ...
        tbl(
            [
                ...
                ["🧪", "Testdata Generator", "Synthetische Testdaten erstellen",    "verfügbar"],
                ["🔧", "Helper",             "JSON-Dateien zusammenführen",         "verfügbar"],
                ["🗂️", "Solutions &amp; Portfolios", "Aggregierte Reports über mehrere ARTs", "verfügbar"],
            ],
    ...
    story += [
        ...
        tbl(
            [
                ...
                ["🧪", "Testdata Generator", "Generate synthetic test data",       "available"],
                ["🔧", "Helper",             "Merge JSON files",                   "available"],
                ["🗂️", "Solutions &amp; Portfolios", "Aggregated reports across multiple ARTs", "available"],
            ],
            col_widths=[1.2*cm, 3.8*cm, 7.5*cm, 3*cm],
        ),
        Spacer(1, 0.5*cm),
    ...
    story += [
        ...
        tbl(
            [
                ...
                ["🧪", "Testdata Generator", "Generare date de test sintetice",     "disponibil"],
                ["🔧", "Helper",             "Combinare fisiere JSON",             "disponibil"],
                ["🗂️", "Solutions &amp; Portfolios", "Rapoarte agregate pe mai multe ART-uri", "disponibil"],
            ],
            col_widths=[1.2*cm, 3.8*cm, 7.5*cm, 3*cm],
        ),
        Spacer(1, 0.5*cm),
    ...
    story += [
        ...
        tbl(
            [
                ...
                ["🧪", "Testdata Generator", "Gerar dados de teste sinteticos",       "disponivel"],
                ["🔧", "Helper",             "Combinar ficheiros JSON",              "disponivel"],
                ["🗂️", "Solutions &amp; Portfolios", "Relatorios agregados de varios ARTs", "disponivel"],
            ],
            col_widths=[1.2*cm, 3.8*cm, 7.5*cm, 3*cm],
        ),
        Spacer(1, 0.5*cm),
    ...
    story += [
        ...
        tbl(
            [
                ...
                ["🧪", "Testdata Generator", "Generer des donnees de test synthetiques", "disponible"],
                ["🔧", "Helper",             "Fusionner des fichiers JSON",          "disponible"],
                ["🗂️", "Solutions &amp; Portfolios", "Rapports agreges sur plusieurs ARTs", "disponible"],
            ],
            col_widths=[1.2*cm, 3.8*cm, 7.5*cm, 3*cm],
        ),
        Spacer(1, 0.5*cm),
